...
public sealed class EntourageMemberAddedDomainEvent : DomainEvent
{
    public EntourageMemberAddedDomainEvent(EntourageGroupId entourageGroupId, EntourageMemberId entourageMemberId, WeddingId weddingId)
    {
